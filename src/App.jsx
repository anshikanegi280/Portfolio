...
const App = () => {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#0d1421]"></div>
      
      {/* Secondary gradient overlay for depth */}

      <div className="absolute inset-0 bg-gradient-to-t from-[#151b35]/20 via-transparent to-[#1a1f3a]/15"></div>
      
      {/* Subtle glow effects */}
      
      <div className="absolute inset-0">
        <div className="absolute top-[30%] left-[20%] w-96 h-96 bg-blue-500/8 rounded-full blur-3xl"></div>
        <div className="absolute bottom-[30%] right-[20%] w-80 h-80 bg-purple-500/5 rounded-full blur-3xl"></div>
        <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-400/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-blue-500/[0.01] to-transparent animate-pulse"></div>
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-indigo-500/[0.01] to-transparent animate-pulse delay-1000"></div>
        </div>
      </div>
